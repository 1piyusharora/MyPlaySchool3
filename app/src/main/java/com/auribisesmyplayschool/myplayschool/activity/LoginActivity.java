...
//                Toast.makeText(getApplicationContext(), "Welcome", Toast.LENGTH_LONG).show();
    ...
    void loginFunction(){
        ...
        if (selectedUser == 1){
            ...
            db.collection(Constants.usersCollection).whereEqualTo("userEmail",email1).whereEqualTo("userPassword",pass1).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                @Override
                public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
